	...
	return !viewer.id || !viewer.hasWallet ? (
		<Content className="host-content">
			<div className="host__form-header">
				...
				<Text type="secondary">
					Must be signed in and connected with Stripe to host new listings.
					Please <Link to="/login">login</Link> and connect with Stripe.
				</Text>
			</div>
		</Content>
	) : loading ? (
		<Content className="host-content">
			<div className="host__form-header">
				...
				<Text type="secondary">Your listing is being created</Text>
			</div>
		</Content>
		...
		<Content className="host-content">
			...
			>
				<div className="host__form-header">
					...
					<Text type="secondary">
						This form will collect some basic and additional info about the
						listing.
					</Text>
				</div>
