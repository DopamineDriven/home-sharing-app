...
var client = new stripe_1.default("" + process.env.S_SECRET_KEY, {
    apiVersion: "2020-03-02"
});
exports.Stripe = {
    connect: function (code) { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.oauth.token({
    ...
    charge: function (amount, source, stripeAccount) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.charges.create({
                        amount: amount,
                        currency: "usd",
                        source: source,
