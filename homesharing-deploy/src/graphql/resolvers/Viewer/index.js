...
const logInViaGoogle = (code, token, db, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.cookie("viewer", userId, Object.assign(Object.assign({}, cookieOptions), { maxAge: 24 * 60 * 60 * 1000 }));
        return viewer;
    }
    catch (error) {
    ...
    Mutation: {
        ...
        connectStripe: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const updateRes = yield db.users.findOneAndUpdate({ _id: viewer._id }, { $set: { walletId: wallet.stripe_user_id } }, 
        ...
        disconnectStripe: (_root, _args, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const wallet = yield api_1.Stripe.disconnect(viewer._id);
                if (!wallet) {
