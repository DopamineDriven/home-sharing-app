...
var url = "mongodb+srv://" + process.env.DB_USER + ":" + process.env.DB_PASSWORD + "@" + process.env.DB_CLUSTER + ".mongodb.net/test?retryWrites=true&w=majority";
exports.connectDatabase = function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, db;
